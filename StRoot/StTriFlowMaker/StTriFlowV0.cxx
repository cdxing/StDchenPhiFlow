...
void StTriFlowV0::InitPhi()
{
    ...
    for(Int_t cent = 0; cent < TriFlow::Bin_Centrality_01; cent++)
    {
        ...
        {
          mHist_SE_InvM_ptSetA_centSetA[pt_bin][cent] = new TH1F(Form("Hist_SE_InvM_ptSetA%d_cent%d",pt_bin,TriFlow::Centrality_01[cent]),
          Form("Hist_SE_InvM_ptSetA%d_cent%s",pt_bin,TriFlow::Centrality_01[cent]),
          200,0.98,1.08);
